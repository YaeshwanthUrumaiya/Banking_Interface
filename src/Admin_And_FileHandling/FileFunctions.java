...
public class FileFunctions {
        ...
        public static void main(String[] args) { //run if you want to reset the 50 preset values, running this will delete all the values you added after this.
            ...
            double[] ANBAL={35843,32688,76023,20421,64285,55991,60809,75191,47061,44111,99693,39416,1827,20439,40054,85230,86674,23694,53399,23760,70026,60554,70395,34598,52855,73078,27205,42843,34171,85421,9697,45479,72894,28591,52218,73769,65601,41756,69092,12416,96223,44807,25126,61353,90945,47470,75830,39693,20175,75347};
            double[] CSS= {51,82,23,23,57,94,85,59,24,87,61,0,52,59,84,15,28,17,35,62,64,51,71,51,63,19,83,52,8,90,36,84,23,71,60,30,63,98,75,53,92,19,16,29,68,30,65,17,26,54};
            insert(0,ANN);
            insert(1, ANPW);
            insert(2,ANBAL);
            insert(3,CSS);
